...
import RecebimentoPendencias from "./RecebimentoPendencias";
...
export default function ValidadeEstoque({ rawData }: ValidadeEstoqueProps) {
  ...
  const lotesAgregados = useMemo(() => {
    ...
    for (const lote of lotesConsolidados) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm p-6 overflow-hidden">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white [color-scheme:light_dark]">
        ...
        {isScanningSearch && (
          <div className="mb-6 bg-slate-50 dark:bg-slate-800/30 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
            <div className="flex items-center justify-between mb-2">
              <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">Escanear para Filtrar</h4>
              <button onClick={() => setIsScanningSearch(false)} className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div
              id="reader-search"
              className="w-full bg-slate-100 dark:bg-slate-800 rounded-lg overflow-hidden min-h-[200px] flex items-center justify-center mb-2"
            >
              <span className="text-slate-400 text-sm">Carregando câmera...</span>
            </div>
            <p className="text-xs text-center text-slate-500 dark:text-slate-400">
              Aproxime o código de barras da câmera. A iluminação e o foco podem afetar a velocidade.
            </p>
          </div>
        )}
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <p className="font-medium text-slate-900 dark:text-white [color-scheme:light_dark]">{inboundData.produto}</p>
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block p-2.5 dark:bg-slate-950 dark:border-slate-800 dark:text-white [color-scheme:light_dark]"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">
              ...
              <div className="relative">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block p-2.5 dark:bg-slate-950 dark:border-slate-800 dark:text-white [color-scheme:light_dark]"
